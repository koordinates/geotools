...
public class WFSFeatureCollectionEncodingTest {
    ...
    public void setUp() throws Exception {
        ...
        b.add(
                new GeometryFactory()
                        .createLineString(
                                new Coordinate[] {new Coordinate(4, 4), new Coordinate(5, 5)}));
        b.add(5);
        store.addFeature(b.buildFeature("five"));
    }

    /**
     * An empty geometry is valid and must encode as an element with no positions, rather than
     * blowing up the whole feature collection halfway through encoding.
     */
    @Test
